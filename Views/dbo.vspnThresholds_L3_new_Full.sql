...
--/****** Object:  View [dbo].[vspnThresholds_L3_new_Full]    Script Date: 05/10/2018 12:36:00 ******/
--SET ANSI_NULLS ON
--GO
...
Create view  [dbo].[vspnThresholds_L3_new_Full] as
...
from  [WEB_L3W].[dbo].[Web_Group_Thresholds]a  join [WEB_L3W].[dbo].webgrspn b on a.webGRid =b.webGRid
join [WEB_L3W].[dbo].webgr g on g.webGRid=b.webgrid
...
--   --Select * from WEB_L3W.dbo.Web_Group_Thresholds where webGRid=31
