...
create view  [dbo].[vspnThresholds_L2_new_Full] as
...
from  [WEB_L2W].[dbo].[Web_Group_Thresholds]a  join [WEB_L2W].[dbo].webgrspn b on a.webGRid =b.webGRid
join [WEB_L2W].[dbo].webgr g on g.webGRid=b.webgrid
